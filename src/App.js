...
function App() {
  return (
    <div className="App">
      ...
      <div className="video-section">
        <div className="video-pair">
          <div className="video-left">
            <h2 className="title">PARTE I - HISTORIA DEL "APOSTOL SANTIAGO"</h2>
            <div className="video-wrapper">
              <YouTubeVideo_1VR videoId="RfMapUg4VA0" />
            </div>
          </div>
          <div className="video-right">
            <h2 className="title">PARTE II - ENTREVISTA NARRATIVA A FUNDADORES DE LA FRATERNIDAD MORENADA "SAN GABRIEL"</h2>
            <div className="video-wrapper">
      ...
      <h2 className="title">DOCUMENTAL "TATA SANTIAGO" - VERSIÓN EXTENDIDA PARTE I y PARTE II</h2>
      <div className="video-wrapper">
